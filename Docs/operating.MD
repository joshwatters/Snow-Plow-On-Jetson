...
- [Init.py](./RobotGPS.py): initializes ROS core, ROS lidar functionality/Hector SLAM, and rosserial for arduino communication.
: executes ```main.py``` in this directory's ```src``` folder.  
